...
const debug = require('debug')('camelz:cli:stack');
...
program.description('Camelz Framework Stack Sub-Commands');
...
program.command('list')
       .description('Camelz Framework List Stacks command')
       .option('-s, --stack-name <stack>', 'Stack name', /^[A-Z][-A-Za-z0-9]{3,63}$/)
       .action(async (options) => {
          try {
            debug(`camelz-stack list()`);
...
program.command('create')
       .description('Camelz Framework Create Stack command')
       .option('-s, --stack-name <stack>', 'Stack name', /^[A-Z][-A-Za-z0-9]{3,63}$/)
