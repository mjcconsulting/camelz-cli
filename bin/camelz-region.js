...
const debug = require('debug')('camelz:cli:region');
...
program.description('Camelz Framework Region Sub-Commands');

program.option('    --config <path>', 'Camelz Framework Configuration Repository', defaults.config)
       .option('    --templates <path>', 'Camelz Framework Templates Repository', defaults.templates)
       .option('    --functions <path>', 'Camelz Framework Functions Repository', defaults.functions)
       .option('    --scripts <path>', 'Camelz Framework Scripts Repository', defaults.scripts)
       .option('    --system <system>', 'Camelz Framework System Name', defaults.system)
       .option('    --account <account>', 'Camelz Framework Account Name (or Alias, or Number)', defaults.account)
       .option('    --environment <environment>', 'Camelz Framework Environment Name', defaults.environment)
       .option('    --region <region>', 'Camelz Framework Region Name', defaults.region)
       .option('    --user <user>', 'Camelz Framework User Name', defaults.user)
...
program.command('list')
       .description('Camelz Framework List Regions command')
       .action(async (options) => {
          try {
            debug(`camelz-region list()`);
...
program.command('create')
       .description('Camelz Framework Create Region command')
